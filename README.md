...
| --- | :---: |
| More than 15 git commits | no | --12 not bad!
...
-- admin page looks great!
-- code is easy to read and intuitive
-- love the stars!!!
-- love the styling in general
-- like that you started off right on feelings component

-- start over works but I was surprised it didn't bring me back to feelings component
-- forced data for feelings, understanding, and support components but user may not
    realize that they have to input data to continue

-- lots of repeated code, possibly could have made it it's own component so you only have
    to write it once
-- could have possibly had one reducer...
-- minor** just clean out your un-used imports
